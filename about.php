             ...
             <div class="row g-4">
                 <div class="col-lg-3 col-md-6">
                     <div class="team-card">
                         ...
                         <div class="team-info">
                             <h4 class="text-white">Dawood Bin Aslam </h4>
                             <p>CEO & Founder</p>
                         </div>
                     </div>
                 </div>
                 <div class="col-lg-3 col-md-6">
                     <div class="team-card">
                         <div class="team-image">
                             <img src="./images/basit.jpg" alt="Team Member">
                         </div>
                         <div class="team-info">
                             <h4 class="text-white">Abdul Basit Bedar</h4>
                             <p>CO-Founder</p>
                         </div>
                     </div>
                 </div>
                 ...
                 <div class="col-lg-3 col-md-6">
                     <div class="team-card">
                         <div class="team-image">
                             <img src="./images/ibrahim.jpg" alt="Team Member">
                         </div>
                         <div class="team-info">
