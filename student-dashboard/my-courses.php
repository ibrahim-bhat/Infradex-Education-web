            ...
            <?php if ($result->num_rows > 0): ?>
              <div class="row g-4">
                <?php while($course = $result->fetch_assoc()): 
                  $progress = getCourseProgress($course['id'], $student_id, $conn);
                ?>
                  <div class="col-md-6 col-lg-4">
                    <div class="course-card">
                      <div class="course-image" style="background-image: url('<?php echo $course['image_url'] ?? '../assets/images/course-default.jpg'; ?>')">
                      ...
                      <div class="course-content">
                        ...
                        <div class="course-info">
                          <p><i class="fas fa-user-tie me-2"></i>Instructor: <?php echo htmlspecialchars($course['instructor_name']); ?></p>
